...
namespace dbgen4
{
  ...
  using e_data_statements =
    std::expected<data_statements, exit_status_enum>; ///< expected data_statements or error code
  ...
  private:
    ...
    [[nodiscard]] e_data_statement extract_sql_to_statement(const YAML::Node&     n,
