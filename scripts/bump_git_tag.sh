...
# increments the patch component, rewrites it there and in the matching
# `GIT_TAG vX.Y.Z` example in README.md's "getting the source in" section,
# commits both, tags the commit vX.Y.Z, and pushes the current branch plus
